...
export default function MoonByM() {
  return (
    <div className={styles.container}>
        <div className={styles.hero} style={{backgroundSize: 'cover', backgroundImage: 'url(/mbm-clean.jpg)'}}>
            <div className={styles.gradient}>
                <Image src={mbmLogo} alt="/" width={500} className={styles.heroImg}/>
        ...
        <div className={styles.displayOne} style={{backgroundSize: 'cover', backgroundImage: 'url(/omayma.jpg)', backgroundPosition:'center', backgroundAttachment: 'fixed', backgroundPosition: 'center'}}></div>
            ...
            <div className={styles.displayTwo}>
                <div>
                    <video src={require('/public/mbm-video-mock.mp4')} className={styles.hero} autoPlay muted loop/>
                </div>
